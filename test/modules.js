...
test('index.js of module dir', function() {
    var path = resolve('module-a', { paths: [ fixtures_dir ], package: { main: 'fixtures' } });
...
test('alternate main', function() {
    var path = resolve('module-b', { paths: [ fixtures_dir ], package: { main: 'fixtures' } });
...
test('string browser field as main', function() {
    var path = resolve('module-c', { paths: [ fixtures_dir ], package: { main: 'fixtures' } });
...
test('object browser field as main', function() {
    var path = resolve('module-d', { paths: [ fixtures_dir ], package: { main: 'fixtures' } });
...
test('test core -> module-c replacement', function() {
    ...
    var path = resolve('querystring', parent);
    assert.equal(path, require.resolve('./fixtures/node_modules/module-c/browser'));
});
